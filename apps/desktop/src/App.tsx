...
import { SelectTopicDialog } from "@/components/SelectTopicDialog";
...
import { PRESET_LLM_SERVICES } from "@/lib/llm-services";
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <CreateTopicDialog
        ...
        onTopicNameChange={setTopicNameInput}
      ...
      <SelectTopicDialog
        ...
        topics={topics}
        onSelect={handleSelectTopicAndCreate}
      />
    </div>
  );
}
